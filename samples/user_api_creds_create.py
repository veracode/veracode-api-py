...
the_name = 'sample_name' # fill in with the appropriate username
...
print('Creating API service account with username {}...'.format(the_name))
theuser = Users().create(email=the_email,lastname='demo',firstname='demo',username=the_name,
